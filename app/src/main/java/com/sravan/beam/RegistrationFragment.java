...
public class RegistrationFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        edt_email = view.findViewById(R.id.edt_register_email1);
        edt_pass = view.findViewById(R.id.edt_register_password1);
        edt_cpass = view.findViewById(R.id.edt_register_CPassword1);
        edt_name = view.findViewById(R.id.edt_register_name1);
        edt_location = view.findViewById(R.id.edt_register_location1);
        edt_dob = view.findViewById(R.id.edt_register_dob1);
        edt_gender = view.findViewById(R.id.edt_register_gender1);
        btn_register = view.findViewById(R.id.btn_register1);
